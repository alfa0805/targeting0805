    ...
    <nav id="home">
        <div className={`${tun? "" : ""} max-w-[1100px] h-full py-5 mx-auto px-5 pt-[100px]`}>
          <div className={`flex items-start justify-center gap-10 flex-wrap`}>
            <div data-aos="fade-up" data-aos-duration="3000" className=" w-[45%] max-[770px]:w-full">
            ...
            <div data-aos="zoom-in-up" className="w-[45%] h-full max-[770px]:w-[450px] max-[500px]:w-full">
