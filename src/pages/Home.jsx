    ...
    <nav id="home">
        <div className={`${tun? "" : ""} max-w-[1100px] h-full py-5 mx-auto px-5 pt-[100px]`}>
          <div className={`flex items-start justify-center gap-10 flex-wrap`}>
            <div className="w-[45%] max-[770px]:w-full">
              <h2 className={`${tun? "text-white" : "text-black"} max-[770px]:text-4xl max-[770px]:text-center max-[770px]:w-full mb-[30px] text-5xl font-bold leading-[60px] `}>
              ...
              <div className={`${tun? "bg-gray-700 shadow-gray-500" : "bg-gray-100"} 
            ...
            <div className="w-[45%] h-full max-[770px]:w-[450px] max-[500px]:w-full">
