  ...
  return (
    <div id="about" className="max-w-[1100px] h-full mx-auto px-5 pt-10">
      ...
      <div className="flex items-start justify-center gap-10 max-[770px]:flex-col">
        <div className={`${tun?"bg-gray-700 shadow-gray-600" : "bg-gray-100 shadow-[#dbdbdb]"} shadow-lg w-[58%] h-[490px] p-10 rounded-xl flex flex-col justify-between items-start max-[770px]:w-full max-[500px]:h-full`}>
          <div className="">
        ...
        <div className="w-[38%] h-full max-[770px]:w-full">
          <div className="w-full h-full flex items-center justify-between">
           <div className={`${tun?"bg-gray-700 shadow-gray-600" : "bg-gray-100 shadow-[#dbdbdb]"} shadow-lg w-[28%] h-[150px] rounded-xl`}></div>
           <div className={`${tun?"bg-gray-700 shadow-gray-600" : "bg-gray-100 shadow-[#dbdbdb]"} shadow-lg p-5 w-[68%] h-[150px] rounded-xl`}>
         ...
         <div className="w-full h-full flex items-center justify-between mt-5">
            <div className={`${tun?"bg-gray-700 shadow-gray-600" : "bg-gray-100 shadow-[#dbdbdb]"} shadow-lg w-[28%] h-[150px] rounded-xl`}></div>
           <div className={`${tun?"bg-gray-700 shadow-gray-600" : "bg-gray-100 shadow-[#dbdbdb]"} shadow-lgp-5 w-[68%] h-[150px] rounded-xl`}>
      ...
      <div className="w-full grid grid-cols-3 gap-10 pt-[50px] max-[990px]:grid-cols-2 max-[770px]:grid-cols-1">
        ...
        {map.map((item, index)=>(
          <div key={index} className={`${tun?"bg-gray-700 border-[#03606b] shadow-gray-600":"bg-gray-100 border-[#c6c6c6] shadow-[#e0e0e0]"} 
